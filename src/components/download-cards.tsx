  ...
  return (
    ...
    >
      ...
      <g mask="url(#win-mask0_4942_15704)">
        <path
          d="M12.25 12.25H19.9844V19.9844H12.25V12.25ZM12.25 21.0156H19.9844V28.75H12.25V21.0156ZM21.0156 12.25H28.75V19.9844H21.0156V12.25ZM21.0156 21.0156H28.75V28.75H21.0156V21.0156Z"
          fill="currentColor"
          fillOpacity="0.5"
        />
      </g>
...
function MacIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <path
        d="M0.5 20.5C0.5 9.45431 9.45431 0.5 20.5 0.5V0.5C31.5457 0.5 40.5 9.45431 40.5 20.5V20.5C40.5 31.5457 31.5457 40.5 20.5 40.5V40.5C9.45431 40.5 0.5 31.5457 0.5 20.5V20.5Z"
        stroke="currentColor"
        strokeOpacity="0.1"
      />
      <g clipPath="url(#mac-clip0_4942_15714)">
        <mask
          id="mac-mask0_4942_15714"
          style={{ maskType: "luminance" }}
          maskUnits="userSpaceOnUse"
          x="9"
          y="9"
